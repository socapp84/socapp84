...
class Okur_ana extends StatefulWidget {
  Okur_ana({Key? key}) : super(key: key);

  @override
  State<Okur_ana> createState() => _Okur_anaState();
}

class _Okur_anaState extends State<Okur_ana> {
    ...
    return Scaffold(
                    ...
                    return Flexible(
                      child: ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          ...
                          if (data != null && data.containsKey("okur_ana")) {
                            var yorum = data["okur_ana"] as String;
                            return Padding(
                              padding:
      ...
      floatingActionButton: FloatingActionButton(
        ...
        onPressed: () async {
          ...
          Map<String, dynamic> commentdata = {"okur_ana": commentler.text};
