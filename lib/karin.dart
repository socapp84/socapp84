...
class karin extends StatefulWidget {
  karin({Key? key}) : super(key: key);

  @override
  State<karin> createState() => _karinState();
}

class _karinState extends State<karin> {
    ...
    return Scaffold(
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: SizedBox(
                        ...
                        child: Image.asset(
                          'images/Ekran Görüntüsü (1258).png',
                          fit: BoxFit.cover,
                        ),
                      ),
                    ),
                    ...
                    return Flexible(
                      child: ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          ...
                          if (data != null && data.containsKey("karin")) {
                            var yorum = data["karin"] as String;
                            return Padding(
                              padding:
      ...
      floatingActionButton: FloatingActionButton(
        ...
        onPressed: () async {
          ...
          Map<String, dynamic> commentdata = {"karin": commentler.text};
