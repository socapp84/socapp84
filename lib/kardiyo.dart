...
class kardiyo extends StatefulWidget {
  kardiyo({Key? key}) : super(key: key);

  @override
  State<kardiyo> createState() => _kardiyoState();
}

class _kardiyoState extends State<kardiyo> {
    ...
    return Scaffold(
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: SizedBox(
                        ...
                        child: Image.asset(
                          'images/Ekran Görüntüsü (125).png',
                          fit: BoxFit.cover,
                        ),
                      ),
                    ),
                    ...
                    return Flexible(
                      child: ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          ...
                          if (data != null && data.containsKey("kardiyo")) {
                            var yorum = data["kardiyo"] as String;
                            return Padding(
                              padding:
      ...
      floatingActionButton: FloatingActionButton(
        ...
        onPressed: () async {
          ...
          Map<String, dynamic> commentdata = {"kardiyo": commentler.text};
