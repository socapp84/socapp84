...
class Okur_dirilis extends StatefulWidget {
  Okur_dirilis({Key? key}) : super(key: key);

  @override
  State<Okur_dirilis> createState() => _Okur_dirilisState();
}

class _Okur_dirilisState extends State<Okur_dirilis> {
    ...
    return Scaffold(
                    ...
                    return Flexible(
                      child: ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          ...
                          if (data != null &&
                              data.containsKey("okur_dirilis")) {
                            var yorum = data["okur_dirilis"] as String;
                            return Padding(
                              padding:
      ...
      floatingActionButton: FloatingActionButton(
        ...
        onPressed: () async {
          ...
          Map<String, dynamic> commentdata = {"okur_dirilis": commentler.text};
